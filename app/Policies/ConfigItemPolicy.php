...
class SettingItemPolicy
{
     ...
     */
    public function view(User $user, SettingItem $configitem): bool
    {
     ...
     */
    public function update(User $user, SettingItem $configitem): bool
    {
     ...
     */
    public function delete(User $user, SettingItem $configitem): bool
    {
     ...
     */
    public function restore(User $user, SettingItem $configitem): bool
    {
     ...
     */
    public function replicate(User $user, SettingItem $configitem): bool
    {
     ...
     */
    public function forceDelete(User $user, SettingItem $configitem): bool
    {
