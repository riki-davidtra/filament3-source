...
@section('content')
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-6">
            <h2 class="text-2xl font-semibold text-center mb-6">Buat Password</h2>
            ...
            <form method="POST" action="{{ route('create-password.update') }}">
                ...
                <a href="{{ route('create-password.skip') }}" class="mt-4 block text-center cursor-pointer w-full bg-slate-400 text-white py-2 rounded-lg hover:bg-slate-500 transition duration-200">Lewati</a>
            </form>
        </div>
    </div>
@endsection
